...
export declare function criarAvaliacao(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function listarAvaliacoesPorPacienteId(req: Request<{
    id: string;
}>, res: Response): Promise<Response<any, Record<string, any>>>;
